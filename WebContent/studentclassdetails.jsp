...
<form action="StudentClassDetailsServlet"   id="myform" name="myform" >
<div class="container">
...
<th align="center"><div align="center">Operations</div></th>
 ...
 <tbody>
 <c:forEach var="cs" items="${AllclassesbyCourse}">
<tr>   
    <td align="center">   
