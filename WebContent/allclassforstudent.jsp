...
<form action="StudentAllClassServlet"   id="myform" name="myform" >
<div class="container">
...
<th align="center"><div align="center">Operations</div></th>
 ...
 <tbody>
 <c:forEach var="cs" items="${Allclasses}">
<tr>   
    <td align="center">   
   ...
   <c:set var="week" value="${cs.weekday}"/>
    ...
    <c:if test="${Allclassstatusforstudent[classid] == 1}">
    
    <input type="button" class="Dropclass" name="Dropclass${classid}" id="Dropclass${classid}" value="Drop Class"/> 
    </c:if>
    
     <c:if test="${Allclassstatusforstudent[classid] == 0}">
    
    <input type="button" class="Enrollclass" name="Enrollclass${classid}" id="Enrollclass${classid}" value="Enroll Class"/> 
    </c:if>
 ...
 <script  src="js/allclassforstudent.js"></script>
</form>
