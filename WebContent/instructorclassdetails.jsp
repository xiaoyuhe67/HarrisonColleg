...
<form action="InstructorClassDetailsServlet"   id="myform" name="myform" >
<div class="container">
...
<tr>   
    ...
    <c:if test="${classstatusforinstructor[classid] == 1}">
    
     <a href="InstructorClassDetailsServlet?classid=<c:out value="${classid}"/>" >${cs.crnnumber}</a>
    </c:if>
     
       
        
        <c:if test="${classstatusforinstructor[classid] == 0}">
