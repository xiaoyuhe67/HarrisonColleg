...
<form action="InstructorAllClassServlet"   id="myform" name="myform" >
<div class="container">
...
<tr>   
    ...
    <c:if test="${Allclassstatusforinstructor[classid] == 1}">
     ...
     <a href="InstructorClassDetailsServlet?classid=<c:out value="${classid}"/>" >${cs.crnnumber}</a>
        ...
        <c:if test="${Allclassstatusforinstructor[classid] == 0}">
