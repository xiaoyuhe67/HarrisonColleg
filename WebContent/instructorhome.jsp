...
<form action="InstructorHomeServlet"   id="myform" name="myform" >
<div class="container">
...
<div align="center" Style="background-color: #01579b ;color: #fff;border-bottom-width: 0;font-weight: bold;font-size:16px; height:34px">All My Courses</div>
...
<th align="center"><div align="center">Credits</div></th>
 ...
 <tbody>
 <c:forEach var="course" items="${Allmycourses}">
<tr>   
    <td align="center">   
        <c:set var="myid" value="${course.courseid}"/>
        <a href="InstructorHomeServlet?courseid=<c:out value="${myid}"/>" >${course.coursename}</a>
    <td align="center"> 
